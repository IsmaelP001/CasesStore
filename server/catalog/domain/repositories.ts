import { CreateProduct, MostOrderedProductQuery, Product, ProductById, ProductFilters, ProductSearchCriteria, ProductsResponse, ProductTypeEnum} from "../domain/product.model";
...
export interface IProductRepository {
  getProducts( filter: ProductFilters): Promise<ProductsResponse>;
