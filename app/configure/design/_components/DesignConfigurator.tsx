...
const DesignConfigurator = () => {
  ...
  return (
    <section className="relative py-0   overflow-hidden  ">
      <div className="absolute  top-1.5 left-4 right-0 pr-5 z-[45] h-fit w-full flex justify-between ">
        ...
        <Link className="" href="/">
          <Image
            ...
            width={50}
            height={50}
            className="w-[85px] h-[40px] object-cover pt-1 object-center"
            alt="cartago-logo"
          />
        </Link>
      ...
      <div className=" min-h-[100svh] w-full  pt-1.5  relative  grid grid-rows-[1fr_155px] md:grid-rows-1 md:place-items-center md:grid-cols-2 lg:grid-cols-3   ">
